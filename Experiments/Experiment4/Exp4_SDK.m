...
%
%% Settings
FileNameHs           = 'data/20160316_204204_uVRU_NAV_HS.log';
FileNameLs           = 'data/20160316_204204_uVRU_NAV_LS.log';
rateHS               = 0.005;   % 200Hz
rateLS               = 0.2;     %   5Hz
figureFlag           = 1;
SaveFigures          = 1;
...
%compute pitchangle
pitch = R2D*atan2((accbix-accbix_bias),(sqrt((accbiy-accbiy_bias)^2+(accbiz-accbiz_bias)^2)))    


display("\n\nWithout BIAS compensation")
%compute roll angle
roll = R2D*atan2(-(accbiy),-(accbiz))
%compute pitchangle
pitch = R2D*atan2((accbix),(sqrt((accbiy)^2+(accbiz)^2)))    