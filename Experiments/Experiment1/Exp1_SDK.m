...
%
%% Settings
FileNameHs           = 'data/20160316_203110_uVRU_NAV_HS.log';
FileNameLs           = 'data/20160316_203110_uVRU_NAV_LS.log';
rateHS               = 0.005;   % 200Hz
rateLS               = 0.2;     %   5Hz
figureFlag           = 1;
SaveFigures          = 1;
...
p_bias = mean(vru.dataHS.omgx)
q_bias = mean(vru.dataHS.omgy)
r_bias = mean(vru.dataHS.omgz)
